...
class DuesFieldArray extends React.Component {
  ...
  componentDidMount() {
    console.log('componentDidMount DuesFieldArray ...');
  }

 render() {
   
    return (<div>DuesFieldArray ...</div>);
 }
}
...
const afterSubmit = function(result, dispatch) {
    ...
    //console.log(result);
    dispatch(reset('DuesFieldArray'));
}

export default reduxForm({
  form: 'DuesFieldArray',  // a unique identifier for this form
